...
app.get('/mentalillness/schizophrenia.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'public/schizophrenia.html'));
});
...
app.get('/mentalillness/ocd.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'public/ocd.html'));
});
...
app.get('/mentalillness/gad.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'public/gad.html'));
});
